...
export function AnalyticsModal({ isOpen, onClose, activity }: AnalyticsModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-bg-app/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="bg-bg-card border border-zinc-800 rounded-md max-w-xl w-full shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-4">
                        <div className="bg-bg-subtle/50 p-4 rounded-md border border-zinc-800/50">
