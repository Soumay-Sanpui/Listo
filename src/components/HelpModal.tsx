                        ...
                        <div className="grid gap-4">
                            ...
                            <div className="flex gap-4">
                                <div className="w-8 h-8 rounded-md bg-purple-500/10 text-purple-400 flex items-center justify-center shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 5v11" /><path d="M12 5v6" /><path d="M18 5v14" /><rect width="18" height="18" x="3" y="3" rx="2" /></svg>
                                </div>
                                <div className="space-y-1">
                                    <p className="text-sm font-semibold text-text-primary">Kanban Boards</p>
                                    <p className="text-xs text-text-secondary leading-relaxed">
                                        Choose <span className="text-purple-400 font-bold">Kanban</span> when creating a board to visualize your workflow with drag-and-drop columns: To Do, In Progress, and Done.
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-4">
